        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse("http://172.16.80.10/16mca021/Test/create.php").newBuilder();
        ...
        btnRead.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse("http://172.16.80.10/16mca021/Test/read.php").newBuilder();
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse("http://172.16.80.10/16mca021/Test/update.php").newBuilder();
                    urlBuilder.addQueryParameter("PID", txtPID.getText().toString());
                    urlBuilder.addQueryParameter("PName", txtPName.getText().toString());
                    urlBuilder.addQueryParameter("Price", txtPrice.getText().toString());
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse("http://172.16.80.10/16mca021/Test/delete.php").newBuilder();
                    urlBuilder.addQueryParameter("PID", txtPID.getText().toString());
